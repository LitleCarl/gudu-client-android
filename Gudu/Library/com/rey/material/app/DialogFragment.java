...
public class DialogFragment extends android.support.v4.app.DialogFragment{
    ...
    public interface Builder{
         ...
         */
        public com.gudu.morning.app.Dialog build(Context context);
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        com.gudu.morning.app.Dialog dialog = mBuilder == null ? new Dialog(getActivity()) : mBuilder.build(getActivity());
